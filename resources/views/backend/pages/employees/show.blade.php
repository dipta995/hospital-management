                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="referPaymentModalLabel">Add Salary <strong class="text-danger">{{ $singleData->name }}</strong></h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-danger"
                                                   href="{{ route('admin.employees.salary.delete',$item->id) }}"
