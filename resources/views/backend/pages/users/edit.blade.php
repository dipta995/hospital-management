        ...
        <div class="crud-card">
            ...
            <form method="post" action="{{ route($pageHeader['update_route'], $edited->id) }}">
                        ...
                        <div class="row crud-form-grid g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" name="blood_group" id="blood_group">
                                    @foreach(['A+', 'A-', 'B+', 'B-', 'AB+', 'AB-', 'O+', 'O-'] as $group)
                                        <option value="{{ $group }}" @selected(old('blood_group', $edited->blood_group) == $group)>{{ $group }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" name="gender" id="gender">
                                    <option @selected(old('gender', $edited->gender) == 'Male') value="Male">Male</option>
                                    <option @selected(old('gender', $edited->gender) == 'Female') value="Female">Female</option>
                                    <option @selected(old('gender', $edited->gender) == 'Other') value="Other">Other</option>
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" name="marital_status" id="marital_status">
                                    ...
                                    @foreach(['Single', 'Married', 'Divorced', 'Widowed'] as $status)
                                        <option value="{{ $status }}" @selected(old('marital_status', $edited->marital_status) == $status)>{{ $status }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <input id="occupation" class="form-control" name="occupation" type="text" value="{{ old('occupation', $edited->occupation) }}">
                                @error('occupation')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-4">
                                ...
                                <input id="religion" class="form-control" name="religion" type="text" value="{{ old('religion', $edited->religion) }}">
                                @error('religion')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="crud-form-actions">
                    ...
                    <button type="submit" class="btn btn-crud-submit">Update Patient</button>
                </div>
            </form>
        </div>
    </div>
