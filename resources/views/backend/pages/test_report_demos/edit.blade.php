                            ...
                            <form class="cmxform" method="post" action="{{ route($pageHeader['update_route'], $edited->id) }}">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <x-default.input name="type" value="{{ old('type',$edited->type) }}" class="form-control" id="type" type="text"></x-default.input>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="test_report" id="test_report" class="form-control" cols="30" rows="10">{!! old('test_report', $edited->test_report) !!}</textarea>
