...
@section('admin-content')
    @php $userGuard = Auth::guard('admin')->user(); $perm = 'pharmacy_types'; @endphp
    <div class="crud-page pharm-page container-fluid py-3">
        @include('backend.layouts.partials.crud-hero', ['heroTitle' => $pageHeader['title'], 'heroSubtitle' => 'Product types', 'heroIcon' => 'fa-shapes', 'heroCreateRoute' => $userGuard->can("{$perm}.create") ? $pageHeader['create_route'] : null, 'heroCreateLabel' => 'Add Type'])
        <div class="crud-card">
