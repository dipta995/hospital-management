...
@section('admin-content')
    @php $userGuard = Auth::guard('admin')->user(); $perm = 'pharmacy_units'; @endphp
    <div class="crud-page pharm-page container-fluid py-3">
        @include('backend.layouts.partials.crud-hero', ['heroTitle' => $pageHeader['title'], 'heroSubtitle' => 'Quantity units (tablet, bottle...)', 'heroIcon' => 'fa-balance-scale', 'heroCreateRoute' => $userGuard->can("{$perm}.create") ? $pageHeader['create_route'] : null, 'heroCreateLabel' => 'Add Unit'])
        <div class="crud-card">
