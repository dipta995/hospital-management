    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Edit Recept #{{ $edited->id }}</h4>
                        ...
                        <form method="POST" action="{{ route($pageHeader['update_route'], $edited->id) }}">
                            ...
                            <div class="form-group">
                                <label for="created_date">Created Date <strong class="text-danger">*</strong></label>
                                <input type="date" id="created_date" name="created_date" class="form-control" value="{{ old('created_date', $edited->created_date) }}">
                            </div>
