    ...
    plotOptions: {
        radialBar: {
            ...
            dataLabels: {
                ...
                value: {
                    offsetY: 55, fontSize: "20px", color: void 0, formatter: function (e) {
                        return e + "%"
                    }
                }
            },
...
chart.render();
options = {
    series: [{name: "Page Views", type: "bar", data: [34, 65, 46, 68, 49, 61, 42, 44, 78, 52, 63, 67]}, {
        name: "Clicks",
        type: "area",
    ...
    fill: {
        opacity: [1, 1],
        type: ["solid", "gradient"],
        gradient: {type: "vertical", inverseColors: !1, opacityFrom: .5, opacityTo: 0, stops: [0, 90]}
    },
...
class VectorMap {
    initWorldMapMarker() {
        new jsVectorMap({
            ...
            zoomButtons: !1,
            markersSelectable: !0,
            markers: [{name: "Canada", coords: [56.1304, -106.3468]}, {
                name: "Brazil",
            ...
            markerStyle: {initial: {fill: "#7f56da"}, selected: {fill: "#1bb394"}},
